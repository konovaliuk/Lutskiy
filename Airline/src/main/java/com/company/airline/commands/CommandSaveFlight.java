...
public class CommandSaveFlight implements ICommand {
	private static final Logger LOGGER = Logger.getLogger(CommandSaveFlight.class);
	...
	public String execute(HttpServletRequest request, HttpServletResponse response)
		...
		flight.setId(Long.parseLong(request.getParameter("id")));
		...
		LOGGER.info("flight saved: " + flight.toString());
